<template>
  <div class="card flex justify-center">
    <Menu :model="items" class="w-full md:w-[15rem]">
      <template #start>
        <span
            class="inline-flex items-center gap-1 px-2 py-2 w-full sm:w-[15rem]"
        >
          <svg
              width="35"
              height="40"
          ...
          >PRIME<span class="text-primary-500 dark:text-primary-400"
          >APP</span
          ></span
          >
        </span>
      ...
      <template #submenuheader="{ item }">
        <span
            class="text-primary-500 dark:text-primary-400 font-bold leading-none"
        >{{ item.label }}</span
        >
      </template>
